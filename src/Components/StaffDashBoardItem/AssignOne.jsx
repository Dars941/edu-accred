...
function AssignOne() {
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="text-2xl pb-4 font-medium">Assignment One Question Paper</div>
          ...
          <ul className="flex flex-col ">
            {pdfFiles.map((file, index) => (
              ...
              >
                ...
                <a
                  href={`https://jubfonzpooabcktpgfip.supabase.co/storage/v1/object/public/AssignOne/pdfs/${name}/${selectedSubject}/${file.name}?t=${file.last_modified}`}
                  download
