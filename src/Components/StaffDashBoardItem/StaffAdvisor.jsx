      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.content}>
               Graduates shall evolve as globally competent Computer engineers for developing innovative solutions in multidisciplinary domains.
              {'\n'}
               Graduates shall have up-to-date knowledge in Computer Science & Engineering along with broad knowledge of mathematics, science, management, and allied engineering to promote their career.
              {'\n'}
               Graduates shall nurture team spirit, ethics, social values, communication skills, and leadership, enabling them to become better professionals of tomorrow.
            </Text>
          </View>
